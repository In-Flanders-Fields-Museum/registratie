...
| Objectcategorie (OC)*                   | [Term_objectcategorie](https://www.projectcest.be/wiki/Publicatie:Invulboek_objecten/Veld/Term_objectcategorie)                         | documenten<br>militaire documenten<br>correspondentie<br>cartografische documenten<br>publicaties<br>grafiek<br>ruilmiddelen<br>handschriften                                                                |
| Objectnaam (OB)*                        | [Term_objectnaam](https://www.projectcest.be/wiki/Publicatie:Invulboek_objecten/Veld/Term_objectnaam)                                   | document (object genre)                                 |
| Titel (TI)*                             | [Titel](https://www.projectcest.be/wiki/Publicatie:Invulboek_objecten/Veld/Titel)                                                       | Indien het document een officiële titel draagt, neem deze over en plaats deze tussen haakjes.<br> Noteer anders kort [een toegekende titel](https://in-flanders-fields-museum.github.io/registratie/algemeen/identificatie.html#titel). Indien een plaatsnaam of datering gekend is, vul deze in kort aan bij de titel: <br> *vb: Observatieballon wordt in gereedheid gebracht te Langemark, 1915*                                                                      |
...
| Vervaardiger rol (FU)                   | [Rol_vervaardiger](https://www.projectcest.be/wiki/Publicatie:Invulboek_objecten/Veld/Rol_vervaardiger)                                 |                                                               |
...
| techniek (TK)*                          | [Term_techniek](https://www.projectcest.be/wiki/Publicatie:Invulboek_objecten/Veld/Term_techniek)                                       |                                                          |
| materiaal (MA)*                         | [Term_materiaal](https://www.projectcest.be/wiki/Publicatie:Invulboek_objecten/Veld/Term_materiaal)                                     |  |
...
| Referentie gerelateerd object (rt)    | [Identificatie_gerelateerd_object](https://www.projectcest.be/wiki/Publicatie:Invulboek_objecten/Veld/Identificatie_gerelateerd_object) | Nummer van documentaire collectie                                         |
